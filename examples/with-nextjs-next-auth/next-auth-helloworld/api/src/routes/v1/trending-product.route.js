...
const trendingProductValidation = require('../../validations/trending-product.validation');
const trendingProductController = require('../../controllers/trending-product.controller');

router
  .route('/')
  .post(
    auth('manageTrendingProduct'),
    validate(trendingProductValidation.createTrendingProduct),
    trendingProductController.createTrendingProduct
  )
  .get(
    validate(trendingProductValidation.getTrendingProductsAdvanced),
    trendingProductController.getTrendingProductsAdvanced
  )
  .get(validate(trendingProductValidation.getTrendingProducts), trendingProductController.getTrendingProducts);
