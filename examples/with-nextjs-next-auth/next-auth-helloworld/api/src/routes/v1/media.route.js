...
// TODO: validate(mediaValidation.getMediasAdvanced),
router.route('/:uuid').get(mediaController.getMedia);

// // TODO: resume auth('manageMedia'),
// // TODO: validate(mediaValidation.createMedia),
router.route('/upload').post(upload.single('file'), mediaController.createMedia);
