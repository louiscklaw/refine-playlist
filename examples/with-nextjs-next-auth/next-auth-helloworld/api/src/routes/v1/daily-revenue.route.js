...
const DailyRevenueValidation = require('../../validations/daily-revenue.validation');
const DailyRevenueController = require('../../controllers/daily-revenue.controller');

router.route('/').get(validate(DailyRevenueValidation.getDailyRevenues), DailyRevenueController.getDailyRevenues);
