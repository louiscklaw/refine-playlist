...
const NewCustomersValidation = require('../../validations/new-customers.validation');
const NewCustomersController = require('../../controllers/new-customers.controller');

// validate(NewCustomersValidation.getNewCustomers),
router.route('/').get(NewCustomersController.getNewCustomers);

// router.route('/').get((req, res, next) => {
//   console.log('something1122');
//   req.query.color1 === 'red'; // true
//   req.query.color2 === 'blue'; // true
//   res.send({ d: req.query });
// });

// router.use('/something', (req, res, next) => {
//   console.log('something1111');
//   req.query.color1 === 'red'; // true
//   req.query.color2 === 'blue'; // true
//   res.send({ d: req.query });
// });
