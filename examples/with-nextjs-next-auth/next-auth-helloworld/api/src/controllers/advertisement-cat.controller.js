...
const getAll = catchAsync(async (req, res) => {
  ...
  let { result, count } = await advertisementCatService.getAll(req.query);
...
const getById = catchAsync(async (req, res) => {
  let { advertisementCatId } = req.params;
  const result = await advertisementCatService.getById(advertisementCatId);
