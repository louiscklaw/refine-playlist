...
const ChevronLeftIcon = "L";
const ChevronRightIcon = "R";
const ChevronsLeftIcon = "LL";
const ChevronsRightIcon = "RR";
...
export const PostList: React.FC = () => {
  ...
  const columns: Array<Column> = React.useMemo(
    () => [
      ...
      { id: "title", Header: "Title", accessor: "title", filter: "contains" },
      { id: "status", Header: "Status", accessor: "status" },
      { id: "createdAt", Header: "CreatedAt", accessor: "createdAt" },
      {
        id: "action",
        Header: "Action",
        accessor: "id",
      ...
      <div className="mb-3 mt-1 flex items-center justify-between">
        <div>
          ...
          <input
            ...
            value={filters.find((filter: any) => filter.id === "title")?.value}
